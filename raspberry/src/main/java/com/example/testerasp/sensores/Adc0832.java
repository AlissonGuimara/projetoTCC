...
public class Adc0832 implements AutoCloseable {
    ...
    public static final String DEFAULT_PI_PIN_CLK = "BCM24";
    public static final String DEFAULT_PI_PIN_D0 = "BCM20";
    public static final String DEFAULT_PI_PIN_D1 = "BCM23";
    public static final String DEFAULT_PI_PIN_CS = "BCM18";
